    ...
    render() {
        return(
            <View style={styles.container}>
                ...
                <Image style={styles.image} source={require('../images/square.png')}/>
                <Text style={styles.caption}>“The ratio of perimeter to width for a square”</Text>
                ...
                <Image style={styles.image} source={require('../images/octagon.png')}/>
                <Text style={styles.caption}>“The ratio of perimeter to width for an octagon”</Text>
                ...
                <Image style={styles.image} source={require('../images/circle.png')}/>
                <Text style={styles.caption}>“The ratio of circumference to diameter for a circle”</Text>
