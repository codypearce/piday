    ...
    render() {
        return(
            <View style={styles.container}>
               <Text style={styles.message}>Pi is perhaps the best-known mathematical constant among non-mathematicians, and the public’s fascination with the number shows through the countless references to and celebrations of pi in popular culture. It is referenced in numerous books and movies, including <Text style={styles.italic}>Mission Impossible</Text> and <Text style={styles.italic}>The Net</Text>. It plays a pivotal role in the Darren Aronofsky thriller <Text style={styles.italic}>Pi</Text>, and provides the main character in <Text style={styles.italic}>Life of Pi</Text> with his nickname. The writing team behind the animated sitcom <Text style={styles.italic}>The Simpsons</Text>, who are known for their mathematical backgrounds, take every opportunity to include references to pi in their work. The digits of pi have inspired a song by Kate Bush, as well as the <Text style={styles.link}  onPress={ () => this._navigate('Glossary') }>version numbers</Text> of the typesetting computer program TeX. Its creator, Donald Knuth, plans to approach pi with each successive version number (<Text style={styles.italic}>i.e.</Text> 3, 3.1, 3.14), with the current version being 3.14159265.
               </Text>
