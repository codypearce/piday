...
const title = 'Pi in Math & Science';

const content = <View style={styles.container}>
                    <Text style={styles.message}>Although the original use of the number pi was simply to relate a circle’s circumference to its diameter, it has since proven ubiquitous in math and science. The appearance of pi in many mathematical formulas can be traced to its role in defining the standard unit of angular measure, the radian. The common unit of angular measure, the degree, is defined arbitrarily. An angle that completes one full revolution (i.e. a circle) is defined as having 360 degrees, but the number 360 was chosen simply because the Babylonian numbering system was based around the number 60. The radian is the result of thinking about a circle as a radius sweeping out an arc, or small section of the circumference. If a circle has a radius of r, it will have a circumference of 2πr. If the number of radians in a circle is defined to be 2π, then the length of an arc will be simply rθ, where θ is the angle, in radians, that the radius must sweep through to form the arc. Consequently, if the angle swept is 1 radian, then the arc length is exactly equal to the radius.
                    </Text>
                    <Text style={styles.message}>Because of this definition of a radian, it is common to express angles as fractions of pi. Therefore pi is involved in calculations of angles, lengths, and areas of all other geometric figures. This is especially important in the case of a triangle, because the lengths of the sides of a triangle define the basic trigonometric functions sine, cosine, and tangent. Trigonometry is a well-studied and pervasive field of mathematics, and thus these functions cause pi to appear in many equations in which circles are not directly involved. One example of such an equation is the solution to Buffon’s needle problem, first stated in 1777 by Georges-Louis Leclerc, Comte de Buffon. Buffon asked “If a needle of length L is dropped onto a surface with many parallel lines each a distance D apart, what is the probability that the needle will cross one of the lines?” The probability for a needle shorter than the distance between lines is surprisingly simple: (2L)/(πD). Therefore, if L and D are known quantities, and the approximate probability of a needle crossing a line is found experimentally by dropping many needles onto the surface and counting the number of needles that do indeed cross a line, then a value for pi can be calculated. In fact, this is an example of a Monte Carlo method, in which a probability, found experimentally or via computer simulation, is used to find a numerical value for some quantity, in this case pi.
                    </Text>
                    ...
                    <Text  style={styles.message}>In addition to being fundamental to geometry, trigonometry, and complex analysis, pi appears sporadically in fields such as number theory, calculus, and probability. Because of its pervasiveness in mathematics, pi tends to appear in many scientific formulas as well. Sometimes, as in the case of the meandering ratio of rivers, the appearance of pi is a result of the direct involvement of circles. The meandering ratio of a river is defined as the ratio of the total length of a river to the straight line distance between the two ends of the river. When conditions are ideal for erosion, the meandering ratio of a river is often close to pi. This is because erosion exacerbates small bends in the river, enlarging the bend until it is nearly a full circle. Thus, the river makes diversions to travel around the circumference of many circles, while the straight line distance only takes into account the diameter of the circle.
                    </Text>
                    <Text  style={styles.message}>Pi also appears in formulas that involve more complicated 3D geometry, such as the formula for the electric field produced by a point charge. A point charge is simply a very small particle with some electric charge, and because it is charged, it produces electric field lines pointing radially outward in all directions. The derivation of the formula involves summing all the electric field lines that pierce an imaginary sphere surrounding the particle, and the formula for the surface area of that sphere involves pi.
                    </Text>
