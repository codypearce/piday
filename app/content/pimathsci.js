    ...
    render() {
        return(
            <View style={styles.container}>
                ...
                <Text style={styles.caption}>“Expressing angles in radians simplifies the calculation of the length of an arc of the circle”</Text>
                ...
                <Image style={styles.image} source={require('../images/radians.png')}/>
                <Text style={styles.caption}>“Euler’s identity relates several fundamental constants together”</Text>

                <Text  style={styles.message}>In addition to being fundamental to geometry, trigonometry, and complex analysis, pi appears sporadically in fields such as number theory, calculus, and probability. Because of its pervasiveness in mathematics, pi tends to appear in many scientific formulas as well. Sometimes, as in the case of the meandering
                ...
                <Image style={styles.image} source={require('../images/river.png')}/>
                <Text style={styles.caption}>“Small bends in a river are eroded into nearly circular arcs”</Text>
                ...
                <Image style={styles.image} source={require('../images/electric.png')}/>
                <Text style={styles.caption}>“The electric field lines from the charged particle in the center radiate outward, piercing an imaginary sphere”</Text>
